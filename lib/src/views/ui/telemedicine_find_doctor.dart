...
import 'package:dpr_patient/src/views/ui/telemedicine_recent_appointment_details.dart';
...
class TelemedicineFindDoctor extends StatefulWidget {
  const TelemedicineFindDoctor({Key? key}) : super(key: key);

  @override
  State<TelemedicineFindDoctor> createState() => _TelemedicineFindDoctorState();
}

class _TelemedicineFindDoctorState extends State<TelemedicineFindDoctor> {
  ...
  void initState() {
    ...
    // if (inPersonVisitProvider.inProgress && !inPersonVisitProvider.inSearch) {
      WidgetsBinding.instance.addPostFrameCallback((_) => inPersonVisitProvider.getInPersonVisitDoctorList(type: "telemedicine"));
    // }
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        backgroundColor: kWhiteColor,
        title: const Text("Telemedicine", style: kAppBarGreenTitleTextStyle),
                  ...
                  child: WidgetFactory.buildPrefixPasswordField(
                    ...
                    onChanged: (String string) {
                      // _debouncer.run(() {
                        ...
                        inPersonVisitProvider.getInPersonVisitDoctorSearch(string, isTelemedicine: true);
                      // });
                    },
                    validator: (val) {},
                        ...
                        ListView.separated(
                            ...
                            itemBuilder: (context, index) {
                              LogDebugger.instance.d(
                                  'in person visit progress: ${inPersonVisitProvider.inProgress}');
                              return (inPersonVisitProvider
                                  .inPersonVisitSearchModel
                                  ?.data
                                  ?.length ??
                                  0) ==
                                  0
                ...
                child: RefreshIndicator(
                  onRefresh: () {
                    return Future.delayed(const Duration(seconds: 1), () async {
                      inPersonVisitProvider.getInPersonVisitDoctorList(type: "telemedicine");
                    });
                  },
                  child: SingleChildScrollView(
                                  ...
                                  return Container(
                                    ...
                                    child: (inPersonVisitProvider
                                      ...
                                      specialty: inPersonVisitProvider
                                          ...
                                          ?.recentAppointments?[index]
                                          .specialtyString,
                                      id: inPersonVisitProvider.inPersonVisitModel
                                          ?.data
                                        ?.recentAppointments?[index]
                                        .appointNoPk,
                                    ),
        ...
        patientInfoProvider.getAppointmentDetails(id ?? 0).then((value) {
          if (value) {
            Navigator.push(
                ...
                MaterialPageRoute(
                    builder: (context) =>
                        TelemedicineRecentAppointmentDetails(provider: patientInfoProvider)));
          }
        });
      },
      child: ShadowContainer(
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: Text(name ?? "N\\A", style: kTitleTextStyle),
            ),
            Padding(
              padding: const EdgeInsets.only(bottom: 2),
              child: Text(specialty ?? "N\\A", style: kSubTitleTextStyle),
            ),
            Padding(
              padding: const EdgeInsets.only(bottom: 2),
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Expanded(
                              child: Text(
                                  "${designation?[0].designation} at ${designation?[0].institution}",
                                  style: TextStyle(
                                      fontSize: size.width / 35,
                                      fontWeight: FontWeight.w500,
                                      color: kDeepBlueColor
                ...
                child: InkWell(
                  onTap: () {
                    Navigator.push(
                        ...
                        MaterialPageRoute(
                            builder: (context) =>
                                TelemedicineBookAppointment(id: personNoPk ?? 0)));
                  },
                  child: Container(
                    height: 200,

...
import 'package:dpr_patient/src/views/ui/telemedicine_appointment_slot.dart';
...
class TelemedicineBookAppointment extends StatefulWidget {
  final int id;
  const TelemedicineBookAppointment({Key? key, required this.id}) : super(key: key);

  @override
  State<TelemedicineBookAppointment> createState() => _TelemedicineBookAppointmentState();
}

class _TelemedicineBookAppointmentState extends State<TelemedicineBookAppointment> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      doctorDetailsProvider.getSlotSummery(doctor: widget.id, type: "telemedicine");
              ...
              children: [
                ...
                Padding(
                  ...
                  child: WidgetFactory.buildButton(
                    ...
                    backgroundColor: doctorDetailsProvider.inProgress ? kLightGreyColor : kMediumGreenColor,
                    borderRadius: 32.0,
...
class Slot extends StatelessWidget {
  final int index;
  const Slot({Key? key, required this.index}) : super(key: key);

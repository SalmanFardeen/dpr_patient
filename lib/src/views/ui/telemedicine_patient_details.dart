...
import 'package:dpr_patient/src/views/ui/telemedicine_display_appointment.dart';
...
class TelemedicinePatientDetails extends StatefulWidget {
  ...
  final String? reportFee;
  final String? name;
  final String? expertise;
  final String? degree;
  final String? image;

  const TelemedicinePatientDetails(
      {Key? key,
        ...
        this.expertise,
        this.degree,
        this.image, this.reportFee,
      })
      : super(key: key);
  @override
  State<TelemedicinePatientDetails> createState() => _TelemedicinePatientDetailsState();
}

class _TelemedicinePatientDetailsState extends State<TelemedicinePatientDetails> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        backgroundColor: kWhiteColor,
        elevation: 0,
        title: const Text("Patient Info", style: kAppBarGreenTitleTextStyle),
                            ...
                            child: ShadowContainer(
                              ...
                              child: SizedBox(
                                ...
                                child: DropdownButtonFormField<ProfileData>(
                                  // value: patientInfoProvider.patientInfoModel?.data?.subProfiles?.first,
                                  ...
                                  onChanged: (ProfileData? value) {
                                    setState(() {
                                      _selectedPatientNoPk =
                                          value?.patientNoPk ?? 1;
                                      _patientName = '${value?.firstName} ${value?.lastName}';
                          ...
                          Container(
                            ...
                            child: Padding(
                              ...
                              child: IconButton(
                                ...
                                //       MaterialPageRoute(
                                //           builder: (
                                //               context) => TelemedicineConfirmAppointment(
                                //               provider: patientInfoProvider,
                                //               issue: _selectedIssue ?? "" + _descriptionETController.text.toString()
                                //           )));
                                // }
                                //     :
                                patientInfoProvider.inProgress
                                  ...
                                  if (_form.currentState!.validate()) {
                                    LogDebugger.instance.d(
                                        "date: ${widget.date}, doctor: ${widget
                                            .doctorFkNo}");
                                    PatientInfoProvider.doctorAppointmentInputModel = DoctorAppointmentInputModel(
                                        ...
                                        phoneMobile: _phoneNumberETController.text,
                                        patientNoFk: _selectedPatientNoPk,
                                        reportShow: _reportShow,
                                        issueNoFk: _selectedIssue,
                                        slotNoPk: widget.slotNoPk,
                                        chiefComplain: _descriptionETController.text
                                            .toString(),
                                        isTelemed: true,
                                      issueTxt: _issueTxt,
                                    ...
                                    Navigator.push(
                                        ...
                                        MaterialPageRoute(
                                            builder: (context) =>
                                                const TelemedicineDisplayAppointment()));                                  }
                                },

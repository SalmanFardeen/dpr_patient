...
class ConfirmAppointment extends StatefulWidget {
  ...
  final bool isRecent;
  const ConfirmAppointment({Key? key, required this.provider, required this.isRecent}) : super(key: key);
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Expanded(
                      flex: 1,
                      child: Text("${provider.appointmentConfirmationWithUploadedFilesModel?.data?.appointment?.doctorFee ?? 0} Tk",
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Expanded(
                        flex: 1,
                        child: Text("${provider.appointmentConfirmationWithUploadedFilesModel?.data?.appointment?.reportFee ?? 0} Tk",
                            style: kTitleTextStyle, textAlign: TextAlign.end))
                  ],
                ),
              ),
                        ...
                        children: [
                          RichText(
                            text: TextSpan(
                                ...
                                children: [
                                  TextSpan(
                                      text: " ${int.parse(PatientInfoProvider.doctorAppointmentInputModel.reportShow == false ? (provider.appointmentConfirmationWithUploadedFilesModel?.data?.appointment?.doctorFee ?? '0') : (provider.appointmentConfirmationWithUploadedFilesModel?.data?.appointment?.reportFee ?? '0')) + 10} Tk",
                                      style: const TextStyle(
                                        color: kOrangeColor,
                                      ))
                                ]),

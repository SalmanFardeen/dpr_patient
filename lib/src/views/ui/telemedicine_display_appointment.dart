...
class TelemedicineDisplayAppointment extends StatefulWidget {
  const TelemedicineDisplayAppointment({Key? key}) : super(key: key);

  @override
  _TelemedicineDisplayAppointmentState createState() =>
      _TelemedicineDisplayAppointmentState();
}

class _TelemedicineDisplayAppointmentState
    extends State<TelemedicineDisplayAppointment> {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text("Confirm Appointment",
            style: kAppBarGreenTitleTextStyle),
        ...
        child: Column(
          ...
          children: [
            Padding(
              ...
              child: HeaderInfo(
                ...
                degree: PatientInfoProvider.doctorAppointmentInputModel.degree ??
                    "",
                image:
                PatientInfoProvider.doctorAppointmentInputModel.doctorImage ??
                        "",
              ),
            ),
            const SizedBox(
            ...
            Padding(
              ...
              child: Text(
                  PatientInfoProvider.doctorAppointmentInputModel.patientName ??
                      "",
            ...
            Padding(
              ...
              child: Text(
                  "Age: ${PatientInfoProvider.doctorAppointmentInputModel.patientAge ?? ""}, ${PatientInfoProvider.doctorAppointmentInputModel.patientGender ?? ""}",
                  style: kSubTitleTextStyle),
            ),
            const Padding(
            ...
            Padding(
              padding: const EdgeInsets.only(left: 16.0, bottom: 4.0),
              child: Text(
                  "${PatientInfoProvider.doctorAppointmentInputModel.issueTxt} ${PatientInfoProvider.doctorAppointmentInputModel.chiefComplain != '' && PatientInfoProvider.doctorAppointmentInputModel.chiefComplain != null ? '(${PatientInfoProvider.doctorAppointmentInputModel.chiefComplain})' : ''}",
                  style: kSubTitleTextStyle),
            ),
            Padding(
              padding: const EdgeInsets.all(16.0),
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Expanded(
                            flex: 5,
                            child: Text(
                                PatientInfoProvider.doctorAppointmentInputModel.appointDate != null
                                    ? (PatientInfoProvider.doctorAppointmentInputModel.appointDate?.split(" ").first ??
                                        "N\\A")
                                    : "N\\A",
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Expanded(
                            flex: 5,
                            child: Text(
                                PatientInfoProvider.doctorAppointmentInputModel.slotTxt?.split(' - ').first !=
                                        null
                                    ? (PatientInfoProvider.doctorAppointmentInputModel.slotTxt?.split(' - ').first ??
                                        "N\\A")
                                    : "N\\A",
                      ...
                      //     Text(
                      //         PatientInfoProvider.doctorAppointmentInputModel.chamberHospitalName ??
                      //             "N/A",
              ...
              child: Row(
                ...
                children: [
                  ...
                  Expanded(
                      flex: 1,
                      child: Text(
                          "${PatientInfoProvider.doctorAppointmentInputModel.doctorFee ?? 0} Tk",
                          style: kTitleTextStyle,
                          textAlign: TextAlign.end))
                ],
              ),
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Expanded(
                        flex: 1,
                        child: Text(
                            "${PatientInfoProvider.doctorAppointmentInputModel.reportFee ?? 0} Tk",
                            style: kTitleTextStyle,
                            textAlign: TextAlign.end))
                  ],
                ),
                          ...
                          RichText(
                            text: TextSpan(
                                ...
                                children: [
                                  TextSpan(
                                      text:
                                          " ${int.parse(PatientInfoProvider.doctorAppointmentInputModel.reportShow == false ? (PatientInfoProvider.doctorAppointmentInputModel.doctorFee ?? '0') : (PatientInfoProvider.doctorAppointmentInputModel.reportFee ?? '0')) + 10} Tk",
                          ...
                          Navigator.push(
                              ...
                              MaterialPageRoute(
                                  builder: (context) => Payment(
                                      totalFee: (int.parse(PatientInfoProvider.doctorAppointmentInputModel.reportShow == false ? (PatientInfoProvider.doctorAppointmentInputModel.doctorFee ?? '0') : (PatientInfoProvider.doctorAppointmentInputModel.reportFee ?? '0')) + 10)
                                          .toString())));
                        }),
                  ),
                ],
